...
#include "NearbyAircraftHarester.h"
...
HRESULT NearbyAircraftHarvester::Init()
{
	HRESULT hr = E_FAIL;
...
HRESULT NearbyAircraftHarvester::Deinit()
{
	HRESULT hr = E_FAIL;
...
HRESULT NearbyAircraftHarvester::Start()
{
...
HRESULT NearbyAircraftHarvester::Stop()
{
	HRESULT hr = S_OK;
...
/*static*/
HRESULT NearbyAircraftHarvester::StartCallback(void* pContext)
{
	HRESULT hr = E_FAIL;
...
/*static*/
HRESULT NearbyAircraftHarvester::StopCallback(void* pContext)
{
	HRESULT hr = E_FAIL;
...
// Frame callback.
void NearbyAircraftHarvester::Invoke(IParameterListV400* pParams)
{
